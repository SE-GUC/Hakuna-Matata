...
router.put('/Question/:id',passport.authenticate('jwt', {session: false}), async (req, res) => {
    try {
        const id = req.params.id
...
router.post('/Question/:id',passport.authenticate('jwt', {session: false}), async (req, res) => {
    ...
    const question = req.body.question
        ...
        if(question.toLowerCase()=="yes"||question.toLowerCase()=="no"){
            ...
            const questions=await bestMatch(question.toLowerCase())
