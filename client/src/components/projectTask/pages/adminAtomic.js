...
export class adminAtomic extends Component {
...
<br></br>
        ...
        <p></p>
        <div>
        <button style={{background:'#940000',width:100,borderRadius:'10%',color:'white',position:'absolute', left:'38%',top:'11%'}}> delete </button>
        </div>
        <p></p>
        <p></p>
        <br></br>
