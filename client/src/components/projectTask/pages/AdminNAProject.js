...
export class AdminNAProject extends Component {
...
<br></br>
        ...
        <button style={{border: '0.7px solid #707070',background:'#940000',width:150,height:25,borderRadius:'8px',color:'white',position:'relative', left:'38%',top:'250%'}}> Delete Project </button>
        </div>
        <p></p>
        <p></p>
        <br></br>
